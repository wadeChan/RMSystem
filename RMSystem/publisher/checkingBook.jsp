...
Book book = null;
int i = 1;
List list = bookDAO.findAllChecking(cookieValue); 
...
<td style="color:#ee0000;">正在审核</td>
<td>
<a href="cancelCheckBook?bookID=<%=book.getBookID() %>" class="button button-primary button-rounded button-small">取消审核</a>
</td>
</tr>  
<%
	}
 }else{%>
 <tr><td>没有正在审核的书本</td></tr>
 <%
 }
 %>
 <%
