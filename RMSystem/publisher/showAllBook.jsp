...
var msg = "${message}"
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">查 看 所 有 图 书
                </h1>
            </div>
        </div>
        <!-- /.row -->
...
<td>
<a href="deleteBook?bookID=<%=book.getBookID() %>" class="button button-primary button-rounded button-small">删除</a>
</td>
</tr>  
<%
i++;
