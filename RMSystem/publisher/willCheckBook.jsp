...
Book book = null;
int i = 1;
List list = bookDAO.findAllUnCheck(cookieValue); 
...
<td style="color:#ee0000;">未审核或审核失败</td>
<td>
<a href="uploadCheckBook?bookID=<%=book.getBookID() %>" class="button button-primary button-rounded button-small">提交审核</a>
</td>
</tr>  
<%
	}
 }else{%>
 <tr><td>没有可以上交审核的书本</td></tr>
 <%
 }
 %>
 <%
